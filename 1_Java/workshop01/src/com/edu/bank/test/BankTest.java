...
public class BankTest {
	public static void main(String[] args) {
		...
		james.openAccount(new Account(jamesAccNumber, jamesBankName));
		james.getAccount().setBalance(jamesBalance);
		...
		tomas.openAccount(new Account(tomasAccNumber, tomasBankName));
		tomas.getAccount().setBalance(tomasBalance);
