...
public class EmployeeManager {
	...
	public void addEmployee(Employee e) {
			if(currentEmps < MAX_EMPLOYEES) emps[currentEmps++] = e;
	}
	...
	public String getJob(Employee e) {
		if(e instanceof Engineer) return "기술자";
		if(e instanceof Secretary) return "임원비서";
		if(e instanceof Manager) return "관리자";
		return "";
	}
