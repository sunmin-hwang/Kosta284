...
public class BookTest {
	public static void main(String[] args) {		
		...
		mgr.addBook(new Magazine("55", "자바a", "Echo", "a.kr", 70, "eeee", 2024, 2));
		mgr.addBook(new Magazine("66", "자바2", "foxtrot", "a.kr", 150, "ffff", 2024, 5));
		...
		aaa : while(true)
		{
			...
			case 4:
				...
				break;
			case 5:
				ArrayList<Book> returnList0=mgr.onlySearchBook();
				for(Book b : returnList0) {
					System.out.println(b);
				}
				break;
